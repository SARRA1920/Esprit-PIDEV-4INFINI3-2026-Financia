...
export class AuthService {
  ...
  /**
   * Efface la session locale et quitte les écrans qui pouvaient encore afficher
   * des données en mémoire (le garde de route ne se réexécute pas sur la même URL).
   */
  logout(): void {
    this.persist(null);
