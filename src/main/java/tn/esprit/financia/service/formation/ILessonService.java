...
public interface ILessonService {
     ...
     * @throws tn.esprit.financia.exception.ValidationException if lesson data is invalid
     */
     ...
     * @throws tn.esprit.financia.exception.ResourceNotFoundException if course not found
     * @throws tn.esprit.financia.exception.ValidationException if any lesson data is invalid
     */
