...
public interface IUserService {
     ...
     * @throws tn.esprit.financia.exception.ValidationException if user data is invalid
     */
     ...
     * @throws tn.esprit.financia.exception.ResourceNotFoundException if user not found
     */
     ...
     * @throws tn.esprit.financia.exception.ResourceNotFoundException if user or course not found
     */
