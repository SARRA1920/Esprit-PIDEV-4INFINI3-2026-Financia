package tn.esprit.financia.util;
...
import tn.esprit.financia.repository.formation.UserRepository;
import tn.esprit.financia.service.formation.IUserService;
...
public class AccessControlUtil {
    ...
    public boolean isAdmin(Long userId) {
        return userRepository.findById(userId)
                .map(user -> user.getRole() == tn.esprit.financia.entities.formation.UserRole.ADMIN)
                .orElse(false);
    }
    ...
    public boolean isUserActive(Long userId) {
        return userRepository.findById(userId)
                .map(tn.esprit.financia.entities.formation.User::getIsActive)
                .orElse(false);
    }
}
