...
public interface ILessonContentService {
     ...
     * @throws tn.fiancia.financia.exception.ValidationException if text is invalid
     */
     ...
     * @return the created lesson content
     * @throws tn.fiancia.financia.exception.ResourceNotFoundException if lesson not found
     * @throws tn.fiancia.financia.exception.ValidationException if file is invalid
     */
     ...
     * @throws tn.fiancia.financia.exception.ResourceNotFoundException if content not found
     */
