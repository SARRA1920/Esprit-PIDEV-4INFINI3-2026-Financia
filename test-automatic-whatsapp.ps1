# Automatic WhatsApp Testing Script
# Run this after restarting your application and joining Twilio sandbox

$baseUrl = "http://localhost:8083/api"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Automatic WhatsApp Testing - User ID 2" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    Write-Host ""
    Write-Host "WHATSAPP AUTOMATICALLY SENT TO USER 2!" -ForegroundColor Magenta
    Write-Host "Phone: +216 20 285 074" -ForegroundColor Magenta
    Write-Host ""
    Write-Host "Check your WhatsApp now! Message should arrive in 1-5 seconds!" -ForegroundColor Cyan
    Write-Host ""
} catch {
...
Write-Host "  WhatsApp: Sent automatically" -ForegroundColor White
Write-Host ""
Write-Host "Expected WhatsApp Message:" -ForegroundColor Cyan
Write-Host "---" -ForegroundColor Gray
Write-Host "Financia - Alerte de Retard" -ForegroundColor White
Write-Host "Bonjour Anas," -ForegroundColor White
Write-Host "Votre paiement du 25/03/2026 est maintenant en retard." -ForegroundColor White
Write-Host "Montant du: 900.000 TND" -ForegroundColor White
Write-Host "---" -ForegroundColor Gray
Write-Host ""
Write-Host "Check your WhatsApp on +216 20 285 074!" -ForegroundColor Magenta
Write-Host ""
